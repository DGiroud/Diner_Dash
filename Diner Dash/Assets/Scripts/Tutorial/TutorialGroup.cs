...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public int customerRange;                                          //Reference for the group size
    ...
    private void Awake()
    {
        ...
        gC = GameObject.Find("GameController").transform;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    private void Update()
    {
        ...
        if (gameObject != gC.GetComponent<TutorialGameController>().selectedGroup)              //Checks if the group is still currently selected by the game controller
